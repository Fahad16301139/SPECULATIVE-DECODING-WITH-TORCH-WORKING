...
parser.add_argument("--speculative-gamma", type=int, default=8, help="Number of speculative tokens to generate")
parser.add_argument("--speculative-temperature", type=float, default=0.7, help="Temperature for speculative sampling")
